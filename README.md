...
`exact_match`. Quando `output_dir` è impostato, ogni combinazione
`split`/`task` produce un file `*.jsonl` facilmente consultabile o
caricabile in spreadsheet per analisi mirate.
