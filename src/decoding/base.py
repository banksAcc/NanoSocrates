...
def decode_to_text(model, tok, input_text: str, **kwargs) -> str:
    ...
    strip_start_token_opt = kwargs.pop("strip_start_token", None)
    ...
    if strip_start_token_opt is None:
        strip_start_token = not enforce_rdf_grammar
    else:
        strip_start_token = bool(strip_start_token_opt)
    ...
    if strip_start_token and ids and ids[0] == start_id:
        ids = ids[1:]
